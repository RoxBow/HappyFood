...
exports.saveRecipeEdamam = fetchRecipeNameEdamam('salad', listResult => {
...
exports.saveRecipeEdama = fetchRecipeNameEdamam('pizza', listResult => {
  listResult.forEach(result => {
    let recipe = new Recipe();
...
exports.saveRecipeEdam = fetchRecipeNameEdamam('burger', listResult => {
  listResult.forEach(result => {
    let recipe = new Recipe();
